...
def analyze_video(source):
    ...
    while True:
        ...
        # Save frame as image if not already saved
        # Save the cropped face image if not already saved
        if not frame_saved:
        ...
        # if not frame_saved:
        #     cv2.imwrite("output/analysed-frame.jpg", frame)
        #     frame_saved = True
...
# UI Implementation
root = tk.Tk()
root.title("Facial Attribute Analysis Software v.0.3")
